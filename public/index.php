...
<head>
  ...
  <meta name="description" content="<?= e($paginaProfissionalizantes ? 'Profissionalizantes EAD - Alfa Pleno' : config('seo_descricao', 'ALFAPLENO — Educação que transforma. Supletivo EJA, Cursos Técnicos e Profissionalizantes com certificação reconhecida, 100% online e no seu ritmo.')) ?>">
  <meta name="theme-color" content="#0c3f9e">
  <title><?= e($paginaProfissionalizantes ? 'Profissionalizantes EAD - Alfa Pleno' : config('seo_titulo', 'ALFAPLENO · Educação que transforma vidas')) ?></title>
