<?php
// unidades.php — onde ficam os polos da ALFAPLENO.
...
$whatsapp = 'https://wa.me/' . config('whatsapp', '5500000000000') . '?text='
  . rawurlencode('Olá! Quero saber qual é a unidade ALFAPLENO mais perto de mim.');
  ...
  <section class="unid-hero">
    <div class="container">
      <div class="unid-hero__inner">
        ...
        <h1><?= e(config('unidades_titulo', 'A ALFAPLENO perto de você')) ?></h1>
        <p class="lead">
          <?= e(config('unidades_subtitulo', 'O curso é 100% online, mas quem faz a matrícula, tira dúvida e acompanha o aluno é gente de carne e osso. Veja abaixo em que cidades a ALFAPLENO já tem unidade.')) ?>
        </p>
  ...
  <section class="section">
    <div class="container container--estreito">
      <div class="section-head">
        ...
        <p>A ALFAPLENO atende hoje inteiramente pela internet: matrícula, tutoria e secretaria acontecem online, sem você precisar sair de casa.</p>
      </div>
