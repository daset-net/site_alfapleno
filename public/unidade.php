<?php
// unidade.php — ficha de uma unidade da ALFAPLENO, polo físico ou a distância.
...
<head>
  ...
  <meta name="description" content="<?= e(($ead ? 'Atendimento ALFAPLENO a distância em ' : 'Unidade ALFAPLENO em ') . ($unidade['cidade'] !== '' ? $unidade['cidade'] : $unidade['nome']) . ($unidade['uf'] !== '' ? ' (' . $unidade['uf'] . ')' : '') . '. Cursos 100% online com matrícula por esta unidade.') ?>">
      ...
      <aside>
        ...
        <div class="ficha-box ficha-box--contato">
          ...
          <div class="ficha-linha">
            ...
            <div><strong>E-mail</strong><span><?= e(config('email_contato', 'contato@alfapleno.com.br')) ?></span></div>
          </div>
          <div class="ficha-linha">
